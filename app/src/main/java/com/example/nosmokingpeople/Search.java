...
import static com.example.nosmokingpeople.R.layout.activity_search;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        push.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("period", WY.getText().toString());
                intent.putExtra("amount", WA.getText().toString());
                intent.putExtra("price", WP.getText().toString());
