...
public class TipViewPager4 extends Fragment{

    public TipViewPager4(){
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup container3, Bundle savedInstanceState) {
        RelativeLayout layout = (RelativeLayout) layoutInflater.inflate(R.layout.tip4, container3, false);
        return layout;
    }
}
